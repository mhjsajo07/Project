...
import com.example.android.lemoblieplayer.adapter.SearchAdapter;
import com.example.android.lemoblieplayer.bean.SearchBean;
import com.example.android.lemoblieplayer.utils.Constants;
import com.example.android.lemoblieplayer.utils.JsonParser;
...
//                    Toast.makeText(SearchActivity.this, "搜索", Toast.LENGTH_SHORT).show();
    ...
    private void showData() {
        if (items != null && items.size() > 0) {
            //设置适配器
            adapter.setmItemDataListData(items);
