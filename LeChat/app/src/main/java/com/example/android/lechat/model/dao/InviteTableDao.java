package com.example.android.lechat.model.dao;
...
import com.example.android.lechat.model.db.DBHelper;
...
public class InviteTableDao {
    private static final String TAG = InviteTableDao.class.getSimpleName();
